...
If you want to continue in this GPU-memory thread, the next piece is [What I Learned Profiling PyTorch Memory Leaks Across Two Backends](/writing/pytorch-memory-leaks-two-backends) — the same Stormlog workflow on MPS and CUDA, with reproducible scripts and cross-backend numbers.
