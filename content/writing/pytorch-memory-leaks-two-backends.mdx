---
slug: "pytorch-memory-leaks-two-backends"
title: "What I Learned Profiling PyTorch Memory Leaks Across Two Backends"
date: "2026-06-03"
excerpt: "Eight leak patterns on MPS and CUDA — CUDA dampens leak signals but does not hide them, and the bugs that matter show up everywhere."
published: true
---
...
![CUDA leak 01 leaky timeline](/images/timeline-leak-01-cuda-leaky.png)
...
![CUDA leak 01 fixed timeline](/images/timeline-leak-01-cuda-fixed.png)
